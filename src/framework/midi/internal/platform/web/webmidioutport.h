 ...
 */
#ifndef MUSE_MIDI_WEBMIDIOUTPORT_H
#define MUSE_MIDI_WEBMIDIOUTPORT_H

#include "imidioutport.h"

namespace muse::midi {
class WebMidiOutPort : public IMidiOutPort
{
public:
    WebMidiOutPort() = default;
    ~WebMidiOutPort() override = default;
...
#endif // MUSE_MIDI_WEBMIDIOUTPORT_H
